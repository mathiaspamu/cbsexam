...
public final class Config {
  ...
  public static void initializeConfig() throws IOException {
    ...
    USER_TTL = json.get("USER_TTL").getAsLong(); //tilføjet
    ORDER_TTL = json.get("ORDER_TTL").getAsLong(); //tilføjet
    ENCRYPTION_KEY=json.get("ENCRYPTION_KEY").getAsString(); // tilføjet
  }
}